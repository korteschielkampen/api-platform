...
var iconvLite = __webpack_require__(102);
// Load Iconv from an external file to be able to disable Iconv for webpack
// Add /\/iconv-loader$/ to webpack.IgnorePlugin to ignore it
var Iconv = __webpack_require__(120);
...
var bomHandling = __webpack_require__(103),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(104); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(118)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(119)(iconv);
}
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(30).concat(__webpack_require__(50)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(30).concat(__webpack_require__(50)) },
        gb18030: function() { return __webpack_require__(115) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(51).concat(__webpack_require__(117)) },
...
var Body = __webpack_require__(29);
...
var convert = __webpack_require__(101).convert;
var bodyStream = __webpack_require__(122);
...
var Body = __webpack_require__(29);
var Response = __webpack_require__(123);
var Headers = __webpack_require__(31);

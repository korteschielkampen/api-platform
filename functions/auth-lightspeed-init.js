...
var convert = __webpack_require__(39).convert;
var bodyStream = __webpack_require__(60);
var PassThrough = __webpack_require__(4).PassThrough;
var FetchError = __webpack_require__(21);
...
__webpack_require__(27).inherits(FetchError, Error);
...
var iconvLite = __webpack_require__(40);
...
var bomHandling = __webpack_require__(41),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(42); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(11) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(11).concat(__webpack_require__(19)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(20).concat(__webpack_require__(55)) },
...
var _createTokens = __webpack_require__(751);

var _createTokens2 = _interopRequireDefault(_createTokens);

var _readAccount = __webpack_require__(752);
...
exports.handler = (() => {
  var _ref = _asyncToGenerator(function* (event, context, callback) {
    ...
    try {
      var tokens = yield (0, _createTokens2.default)(event.queryStringParameters.code, respond);
      var account = yield (0, _readAccount2.default)(tokens, respond);

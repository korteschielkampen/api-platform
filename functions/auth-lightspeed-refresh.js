...
var convert = __webpack_require__(56).convert;
var bodyStream = __webpack_require__(77);
var PassThrough = __webpack_require__(5).PassThrough;
var FetchError = __webpack_require__(34);
...
__webpack_require__(36).inherits(FetchError, Error);
...
var Headers = __webpack_require__(15);
...
var bomHandling = __webpack_require__(58),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(59); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(14).concat(__webpack_require__(32)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(14).concat(__webpack_require__(32)) },
        gb18030: function() { return __webpack_require__(70) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(33).concat(__webpack_require__(72)) },

...
var convert = __webpack_require__(14).convert;
var bodyStream = __webpack_require__(36);
var PassThrough = __webpack_require__(1).PassThrough;
var FetchError = __webpack_require__(9);
...
__webpack_require__(37).inherits(FetchError, Error);
...
exports.handler = function handler(event, context, callback) {
  ...
  console.log(payload)(() => {
    fetch('https://cloud.lightspeedapp.com/oauth/access_token.php', payload).then(response => response.json()).then(json => {
...
var parse_url = __webpack_require__(2).parse;
var resolve_url = __webpack_require__(2).resolve;
...
var iconvLite = __webpack_require__(15);
...
var bomHandling = __webpack_require__(16),
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(4).concat(__webpack_require__(7)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(4).concat(__webpack_require__(7)) },
        gb18030: function() { return __webpack_require__(29) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(8).concat(__webpack_require__(31)) },

...
export default async soldItems => {
  ...
  let count = 1
  while (offset < count) {
    let apiUrl = `https://api.lightspeedapp.com/API/Account/159502/Item.json?load_relations=["Category", "ItemShops", "TagRelations"]&offset=${offset}&itemID=IN,${stringifiedItemIDs}`

...
const redirect_uri = encodeURI('https://integration-platform.korteschielkampen.nl/moneybird-redirect/')
    ...
    return (
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <p>
            Deze link vraagt toegang tot uw account op Moneybird, gebruik deze
